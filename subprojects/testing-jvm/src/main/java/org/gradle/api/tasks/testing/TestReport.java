...
public abstract class TestReport extends DefaultTask {
     ...
     * </ul>
     *
     * @deprecated Use {@link #getTestResultDirs()} and invoke {@link ConfigurableFileCollection#from(Object...)} instead, passing references to {@link Test#getBinaryResultsDirectory()} as arguments.
     * @param results The result objects.
     */
    @Deprecated
    public void reportOn(Object... results) {
        for (Object result : results) {
            addTo(result, getTestResultDirs());
        }
    }
    ...
    void generateReport() {
        ...
        try {
            if (resultsProvider.isHasResults()) {
                ...
                testReport.generateReport(resultsProvider, getDestinationDir().get().getAsFile());
            } else {
